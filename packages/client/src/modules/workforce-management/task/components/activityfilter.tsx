...
export default function activityFilter({ handleGetAllActivity ,setType,handleFiterData,assignedMembers}) {
    ...
    useEffect(()=>{
        ...
        var members = assignedMembers.map(function (data) {
            return {
                text: data.firstName,

...
const index = ({ data }) => {
    ...
    return (
        <>
            <NewToolTip direction='top' message={data?.permission.toUpperCase()}>
            <div className='ml-2 mt-1'>
                    <button className='green-link text-[16px]'
                        onClick={() => {
                            setOpen(true);
                        }}>
                        {' '}
                        <FaKey className='text-defaultTextColor'/>
                    </button>
                </div>
            </NewToolTip>
            {open && (
                            ...
                            <div className='border-0 mb-7 sm:mt-8 rounded-2xl shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none'>
                                ...
                                <div className='card xs:p-4'>
                                    <table className='table-style w-full'>
                                        ...
                                        <tbody>
                                            {data &&
                                                Object.entries(data.permissionConfig).map(function (t, k) {
                                                    return (
                                                        <tr key={t[0]}>
                                                            <td>{capitalizeString(t[0])}</td>
                                                            <td>{t[1]['view'] ? <TiTickOutline color='green' /> : <RxCross2 color='red' />}</td>
                                                            <td>{t[1]['create'] ? <TiTickOutline color='green' /> : <RxCross2 color='red' />}</td>
                                                            <td>{t[1]['edit'] ? <TiTickOutline color='green' /> : <RxCross2 color='red' />}</td>
                                                            <td>{t[1]['delete'] ? <TiTickOutline color='green' /> : <RxCross2 color='red' />}</td>
                                                        </tr>
                                                    );
                                                })}
                                        </tbody>

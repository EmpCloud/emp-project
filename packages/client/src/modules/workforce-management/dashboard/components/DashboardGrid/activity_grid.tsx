...
import {
  getAllActivity,
  getAllActivitySearching,
} from "@WORKFORCE_MODULES/dashboard/api/get";
                                                      ...
                                                      <tr key={key} className='bg-white border-b-0 dark:bg-gray-800 dark:border-gray-700'>
                                                          ...
                                                          <td scope='row' className='py-3 px-6 font-medium text-gray-900 whitespace-nowrap dark:text-white'>
                                                              <div className='flex mb-5 justify-center -space-x-4'>
                                                                  ...
                                                                  <img onClick={()=>handleUserClick(data.userDetails?.isAdmin ,data.userDetails?.id,data.userDetails?.isSuspended)} style={{ cursor: 'pointer' }}
...

{
  /* <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
              ...
              <SearchInput onChange={handleSearchActivity} placeholder={'Search a Activity'} />

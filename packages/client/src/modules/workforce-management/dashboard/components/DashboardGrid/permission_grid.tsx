...
import { getPermissionSearch, getPermisssionGroup } from '@WORKFORCE_MODULES/permission/api/get';
import AddOrEditPermission from '@WORKFORCE_MODULES/permission/components/addOrEditPermission';
import UserPermissionView from '@WORKFORCE_MODULES/permission/components/userPermissionView';

...
import { getAllSubTask, searchSubTask } from '@WORKFORCE_MODULES/task/api/get';
...
const subtask_grid_Large = ({ clickConfig, handleRemoveGrid, data, key, dropdownData, handleSelectStatus, subtaskCount }) => {
                ...
                <div className={clickConfig ? 'opacity-30 ' : 'mt-5'}>
                    <div className='card p-7 w-full d-flex'>
                        <div className='flex justify-between items-center'>
                            <h3 className='heading-medium'>Subtask Large</h3>
                        ...
                        <div className='mt-4'>
                            <div className='overflow-x-auto relative shadow-md sm:rounded-lg'>
                                <table className='w-full text-sm text-left text-gray-500 dark:text-gray-400'>
                                    <thead className='text-base text-gray-700 uppercase bg-blue-300 dark:bg-gray-700 dark:text-gray-400'>
                                        <tr>
                                            ...
                                            <th scope='col' className='py-3 px-6'>
                                                <div className='flex items-center'>Stages</div>
                                            </th>
                                            <th scope='col' className='py-3 px-6'>
...
export default subtask_grid_Large;

...
const project_grid_small = ({ key, projectCount, dashboardConfigDetails, data, clickConfig, handleRemoveGrid, setClickConfig, dropdownData, handleSelectStatus }) => {
            ...
            <div className={clickConfig ? 'outline' : ''}>
                ...
                <div className={clickConfig ? 'opacity-30 ' : 'mt-5'}>
                    <div className='card p-4 w-full d-flex'>
                        ...
                        <div className='mt-4 gap_5 min-h-[303px]'>
                            <div className='overflow-x-auto relative shadow-md sm:rounded-lg w-full max-h-[254px]'>
...
export default project_grid_small;

...
const task_grid_small = ({ clickConfig, handleRemoveGrid, data, key, dropdownData, handleSelectStatus, taskCount }) => {
                ...
                <div className={clickConfig ? 'opacity-30 ' : 'mt-5'}>
                    <div className='card p-7 w-full d-flex'>
                        <div className='flex justify-between items-center'>
                            <h3 className='heading-medium'>Task Grid small</h3>
                        ...
                        <div className='flex justify-between items-center mt-4'>
                            <div className='flex'>
                                <p className='project-details flex items-center pl-0 pr-4'>
                                    ...
                                    Total Task(s) — {taskCount ? taskCount : 0}
                                </p>
                            </div>
                                                    ...
                                                    <>
                                                        <tr className='bg-white border-b dark:bg-gray-800 dark:border-gray-700'>
                                                            <th scope='row' className='py-3 px-6 font-medium text-gray-900 whitespace-nowrap dark:text-white'>
                                                                {data.projectName ? data.projectName : 'Not Assigned'}
                                                            </th>
                                                            <th scope='row' className='max-w-[250px] w-auto py-4 px-6 font-medium text-gray-900 dark:text-white'>
                                                                <span className={`overflow-hidden text-ellipsis`}>{data.taskTitle}</span>
                                                            </th>
                                                            <th scope='row' className='py-3 px-6 font-medium text-gray-900 whitespace-nowrap dark:text-white'>
                                                            ...
                                                            <th scope='row' className='py-3 px-6 font-medium text-gray-900 whitespace-nowrap dark:text-white'>
                                                                <div className='user-profile-img user-img-group items-center cursor-pointer -space-x-4'>
                                                                    ...
                                                                    {filterMembers(data.assignedTo).length > 2 ? (
                                                                        <ToolTip
                                                                            message={
                                                                                data.assignedTo != null
                                                                                    ? data.assignedTo.map(function (d) {
                                    ...
                                    <div className='flex items-center '>
                                        <button
                                            ...
                                            onClick={() => {
                                                ...
                                                handlePaginationTasks('skip=' + 0 + '&limit=' + sortTable.limit);
                                            }}
                                        ...
                                        <button
                                            ...
                                            onClick={() => {
                                                ...
                                                handlePaginationTasks('skip=' + sortTable.skip + '&limit=' + sortTable.limit);
                                            }}
...
export default task_grid_small;

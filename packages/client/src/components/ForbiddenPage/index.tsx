	...
	<div className="container">
		<div className="row">
			<div className="col-sm-8 offset-sm-2 text-gray-50 text-center -mt-52">
				...
				<h1 className="relative text-9xl tracking-tighter-less text-shadow font-inter font-bold">
					<span>4</span><span>0</span><span>3</span></h1>
					<span className="absolute  top-0   -ml-12  text-gray-300 font-semibold">Oops!</span>
					</div>
				<h5 className="text-gray-300 font-semibold -mr-10 -mt-3">Forbidden page</h5>
				<p className="text-gray-100 mt-2 mb-6">  you dont have permission to view this page </p>
				{/* <a

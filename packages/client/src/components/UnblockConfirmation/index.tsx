...
import { FcRotateToPortrait } from 'react-icons/fc';
 const UnblockConfirmation = ({open,close,message,onClick}) => {
  return (
    <>
    {
    open && (
                  ...
                  <div className="rounded-lg bg-white">
                    <div className="text-center sm:my-4 my-2">
                      ...
                      <div className="flex justify-center mt-12">
                        ...
                        <button type="submit" className="confirm-button px-10" onClick={onClick}>Unblock</button>
                      </div>
                    </div>
                  </div>
                </div>
...
export default UnblockConfirmation;
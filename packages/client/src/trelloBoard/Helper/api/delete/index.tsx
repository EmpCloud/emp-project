...
export const deleteSubTaskById = async function (id,updateCardValues) {
  try {
    return await axios.delete(
...
export const deleteSubTask = async function (id,updateCardValues) {
  try {
    return await axios.delete(
      process.env.TASK_API + "/subtask/delete" +id,{
        headers: {
            'Content-Type': 'application/json',
            'x-access-token': Cookies.get('token'),
        },
...
export const deleteTaskStatusById = async function (id) {
  try {
    return await axios.delete(
      process.env.TASK_API + "/task-status/delete?id="+id,{
        headers: {
            'Content-Type': 'application/json',
            'x-access-token': Cookies.get('token'),
        },

...
// const test6 = () => {
//     const [activeConversations, setActiveConversations] = useState([{ name: 'neetu' }, { name: 'neetu' }]);
...
//     useEffect(() => {
//         setUserDetails(JSON.parse(Cookies.get('adminData')));
//     }, []);
//     if (userDetails) {
//         return (
...
//                   />
//                 </div>
//                 <div className="text-sm font-semibold mt-2">{userDetails ? userDetails.firstName + " " + userDetails.lastName : null}</div>
//                 <div className="text-base text-gray-500">{userDetails.isAdmin ? "Admin" : "Member"}</div>
...
//                   </div>
//                   <div className="leading-none ml-1 text-base">Active</div>
//                 </div>
//               </div> */}
...
//                                 {activeConversations &&
//                                     activeConversations.map(function (d) {
//                                         return (
//                                             <button className='flex flex-row items-center hover:bg-gray-100 rounded-xl p-2'>
//                                                 <div className='flex items-center justify-center h-8 w-8 bg-indigo-200 rounded-full'>
//                                                     {/* <img class=" rounded-full" src={userDetails.profilePic} alt="Rounded avatar" /> */}K
//                                                 </div>
...
//                             <div className='flex flex-col space-y-1 mt-4 -mx-2 h-48 overflow-y-auto'>
//                                 {/* {
// activeConversations && activeConversations.map(function(d){
//   return(
//     <button
...
//                     />
//                     <button
//                       className="emoji-icon absolute flex items-center justify-center h-full w-12 right-0 top-0 text-gray-400 hover:text-gray-600"
...
//                                     </button>
//                                     {/* <button
//                       className="flex items-center justify-center hover:bg-indigo-600 rounded-xl text-white px-4 py-1 flex-shrink-0"
//                     >
//                       <span className="ml-2">
//                         <BiMicrophone className='text-black' />
//                       </span>
//                     </button> */}
//                                     <AudioRecording />
//                                 </div>

...
export let autoMailReport = userData => {
    return `
<!DOCTYPE>
<html>
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                <tr>
                                    <td style="color: #153643; font-family: Arial, sans-serif; font-size: 24px;">
                                        <b>${userData.reportsTitle}</b>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="padding: 0 30px 0 30px; text-align: right; font-family: Arial, sans-serif;">
                                        <b>Report Date: </b>${userData.frequency[0].Date.startDate}
                                    </td>
                                </tr>
                            </table>
                        </td>
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="text-align: center; margin-bottom:30px">
                                <tr >
                                    <td
                                        ...
                                        Please see attachment below regarding EmpMonitor report productivity less than ${"rrrrrfrf"}%
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="text-align: center;">
                                <tr>
                                    <td style="color: #ffffff; font-family: Arial, sans-serif; font-size: 14px; line-height: 2;"
                                        >
                                        © EmpMonitor 2020-${moment().format('YYYY')}<br />

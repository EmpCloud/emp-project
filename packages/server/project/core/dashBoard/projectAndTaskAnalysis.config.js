export let projectAndTaskGrid = {
    ...
    // ----------------------- Main Grid(s) -----------------------
    subtask_grid_XL: 0, // SubTask records grid (Long Table - 5 pagination) - View SubTask (SubTask page link)
    ...
    activity_grid: 0, //  Activity records grid (Long Table - 5 pagination) - View, Activity ( Activity page link)
    ...
    activity_Main_categories_grid: 0, // List of Main Category (Project, Task ,edt)

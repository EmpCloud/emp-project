export let taskTaskGrid = {
    ...
    // -----------------------* Main Grid(s) *-----------------------
    project_grid_XL: 0, // Project records grid (Long Table - 5 pagination) - View Projects (Projects page link)
    ...
    project_task: 0, // Tasks list under a project will be displayed in a table - 10 pagination
    ...
    project_by_status: 0, // A Pie/Bar chart with status grouping (Todo, In Progress, etc ...)
    project_stage_grid: 0, // Project list table based on the stage (dev, prod, etc..)
    ...
    task_status: 1, // Pie/Bar chat on the basis of Status Grouping
    ...
    subtask_status: 1, // Pie/Bar chat on the basis of Status Grouping
    ...
    // ----------------------- Main Grid(s) -----------------------
    roles_grid: 0, // Roles records grid (Long Table - 5 pagination) - View Roles (Roles page link)
    project_roles_grid: 0, // List of Roles Projects, All the Projects with 10 pagination
    ...
    roles_progress_grid: 0, // Roles progress percentage
    ...
    member_grid_XL: 0, // Member records grid (Long Table - 5 pagination) - View Member (Member page link)
    ...
    project_members_grid: 0, //  List of members projects, All the projects with 10 pagination
    ...
    role_wise_members: 1, // Pie chart with Grouping of Roles
    permission_members_grid: 0, // List of members permissions, All the permissions with 10 pagination
    members_progress_grid: 0, // Members progress percentage
    ...
    permission_grid: 0, // Permission records grid (Long Table - 5 pagination) - View Permissions (Permissions page link)
    project_permission_grid: 0, // List of permission Projects, All the Projects with 10 pagination
    ...
    permission_progress_grid: 0, // Permission progress percentage
    ...
    activity_progress_grid: 0, // Activity progress percentage
    ...
    // ----------------------- Main Grid(s) -----------------------
    comments_grid: 0, // Comments records grid (Long Table - 5 pagination) - View Comments (Comments page link)
    project_comments_grid: 0, // List of comments Projects, All the Projects with 10 pagination
    ...
    comments_progress_grid: 0, // Comments progress percentage
    ...
    files_grid: 0, // Files records grid (Long Table - 5 pagination) - View Files (Files page link)
    categories_files: 0, //  List of Category of Files(images, pdf, doc, video etc...)
    project_files_grid: 0, // List of files Projects, All the Projects with 10 pagination
    ...
    links_grid: 0, // Files records grid (Long Table - 5 pagination) - View Comments (Comments page link)
    project_links_grid: 0, // List of links Projects, All the Projects with 10 pagination

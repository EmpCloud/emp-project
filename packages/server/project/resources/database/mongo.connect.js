    ...
    initialize() {
        return new Promise((resolve, reject) => {
            ...
            if (mongoAtlasStatus === true) {
                connect(config.get('mongo_atlas_url'), { useNewUrlParser: true, useUnifiedTopology: true });
                console.log('connected to mongo atlas');
            } else if (this.mongoConfiguration.username != '' && this.mongoConfiguration.password != '') {
                connect(`mongodb://${this.mongoConfiguration.username}:${this.mongoConfiguration.password}@${this.mongoConfiguration.host}/${this.mongoConfiguration.db_name}`, {

...
const startServer = () =>
    new Promise((resolve, reject) => {
        ...
        server.listen(port, () => {
            Logger.info(`service listening on ${config.get('project.host_url')} with ${process.env.NODE_ENV} Environment!`);
            console.log(`service listening on ${config.get('project.host_url')} with ${process.env.NODE_ENV} Environment!`);
        });
        resolve(true);
    });
